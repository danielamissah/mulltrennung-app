...
export const translations = {
  en: {
    ...
    manualTitle: 'Browse by item',
    manualSubtitle: 'No barcode? Find your item here.',
    manualBack: 'Back',

    catFood: 'Food & Kitchen',
    catPaper: 'Paper & Cardboard',
    catPlastic: 'Plastic',
    catGlass: 'Glass',
    catMetal: 'Metal & Cans',
    catHazardous: 'Hazardous & Electronics',
    catOther: 'Other',

    itemFruitVeg: 'Fruit & Vegetables',
    itemCookedFood: 'Cooked Food',
    itemCoffeeGrounds: 'Coffee Grounds',
    itemEggshells: 'Eggshells',
    itemBread: 'Bread & Baked Goods',
    itemNewspaper: 'Newspaper',
    itemCardboard: 'Cardboard Box',
    itemMagazine: 'Magazine',
    itemPaperBag: 'Paper Bag',
    itemPizzaBox: 'Pizza Box',
    itemPlasticBottle: 'Plastic Bottle',
    itemPlasticBag: 'Plastic Bag',
    itemYogurtCup: 'Yogurt Cup',
    itemShampooBottle: 'Shampoo Bottle',
    itemPlasticFilm: 'Plastic Film / Wrap',
    itemStyrofoam: 'Styrofoam',
    itemWineBottle: 'Wine Bottle',
    itemBeerBottle: 'Beer Bottle',
    itemJamJar: 'Jam Jar',
    itemSauceBottle: 'Sauce Bottle',
    itemBrokenGlass: 'Broken Glass',
    itemDrinksCan: 'Drinks Can',
    itemFoodCan: 'Food Can / Tin',
    itemAluminiumFoil: 'Aluminium Foil',
    itemBottleCap: 'Bottle Cap / Lid',
    itemBattery: 'Battery',
    itemElectronics: 'Electronics / Devices',
    itemLightBulb: 'Light Bulb',
    itemPaint: 'Paint / Chemicals',
    itemMedication: 'Medication',
    itemNappies: 'Nappies / Diapers',
    itemCigarette: 'Cigarette',
    itemCeramics: 'Ceramics / Porcelain',
    itemClothing: 'Clothing / Textiles',
    itemShoes: 'Shoes',
    itemTetrapak: 'Tetrapak / Juice Carton',
  },
  ...
  de: {
    ...
    // Manual category browser
    manualTitle: 'Nach Gegenstand suchen',
    manualSubtitle: 'Kein Barcode? Hier findest du deinen Artikel.',
    manualBack: 'Zurück',

    catFood: 'Essen & Küche',
    catPaper: 'Papier & Karton',
    catPlastic: 'Kunststoff',
    catGlass: 'Glas',
    catMetal: 'Metall & Dosen',
    catHazardous: 'Sondermüll & Elektro',
    catOther: 'Sonstiges',

    itemFruitVeg: 'Obst & Gemüse',
    itemCookedFood: 'Gekochtes Essen',
    itemCoffeeGrounds: 'Kaffeesatz',
    itemEggshells: 'Eierschalen',
    itemBread: 'Brot & Backwaren',
    itemNewspaper: 'Zeitung',
    itemCardboard: 'Kartonschachtel',
    itemMagazine: 'Zeitschrift',
    itemPaperBag: 'Papiertüte',
    itemPizzaBox: 'Pizzakarton',
    itemPlasticBottle: 'Plastikflasche',
    itemPlasticBag: 'Plastiktüte',
    itemYogurtCup: 'Joghurtbecher',
    itemShampooBottle: 'Shampooflasche',
    itemPlasticFilm: 'Plastikfolie',
    itemStyrofoam: 'Styropor',
    itemWineBottle: 'Weinflasche',
    itemBeerBottle: 'Bierflasche',
    itemJamJar: 'Marmeladenglas',
    itemSauceBottle: 'Soßenflasche',
    itemBrokenGlass: 'Zerbrochenes Glas',
    itemDrinksCan: 'Getränkedose',
    itemFoodCan: 'Konservendose',
    itemAluminiumFoil: 'Aluminiumfolie',
    itemBottleCap: 'Flaschenverschluss',
    itemBattery: 'Batterie',
    itemElectronics: 'Elektrogeräte',
    itemLightBulb: 'Glühbirne',
    itemPaint: 'Farbe / Chemikalien',
    itemMedication: 'Medikamente',
    itemNappies: 'Windeln',
    itemCigarette: 'Zigarette',
    itemCeramics: 'Keramik / Porzellan',
    itemClothing: 'Kleidung / Textilien',
    itemShoes: 'Schuhe',
    itemTetrapak: 'Tetrapak / Saftkarton',
  },
} as const;
